  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Ditt lösenord har uppdaterats. Du är nu inloggad.",
      });
      setIsLoading(false);
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="new-password" type={showNewPassword ? "text" : "password"} placeholder="Minst 6 tecken" value={newPassword} onChange={e => setNewPassword(e.target.value)} required disabled={isLoading} className="transition-all duration-200 focus:shadow-lg focus:shadow-primary/10 pr-10" />
              ...
              <div className="space-y-2">
                ...
                <Input id="confirm-password" type={showNewPassword ? "text" : "password"} placeholder="Ange lösenordet igen" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required disabled={isLoading} className="transition-all duration-200 focus:shadow-lg focus:shadow-primary/10" />
              </div>
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? <div className="flex items-center gap-2">
                    <div className="w-4 h-4 border-2 border-primary-foreground/20 border-t-primary-foreground rounded-full animate-spin" />
                    Uppdaterar...
                  </div> : "Uppdatera lösenord"}
              </Button>
            </form>
          </CardContent>
        </Card>
