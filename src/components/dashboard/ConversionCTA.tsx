    ...
    <Card className="relative overflow-hidden rounded-xl md:rounded-2xl border-0 bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 p-3 md:p-6">
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-start gap-2 md:gap-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-muted-foreground mt-0.5 md:mt-1">
              <span className="font-semibold text-primary">10 min snabbare</span> = <span className="font-semibold text-primary">+{potentialIncrease}%</span> konvertering
            </p>
          </div>
        </div>
        ...
        <Button 
          ...
          size="sm"
          className="rounded-lg md:rounded-xl gap-1.5 shrink-0 h-8 md:h-9 text-xs md:text-sm"
        >
